...
test("string literals", function() {
    equal("quote types are interchangable, but must match.", "quote types are interchangable, but must match.");
    equal("quote types can use both single and double quotes.", "quote types can use both single and double quotes.");
});
